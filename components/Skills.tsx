  ...
  const skillCategories = [
    {
      title: "Frontend",
      icon: Code2,
      skills: ["React", "Next.js", "TypeScript", "Redux Toolkit", "Tailwind CSS"],
      color: "from-blue-500 to-cyan-500",
    },
    {
      title: "Backend",
      icon: Server,
      skills: ["Node.js", "Express", "Python", "Django", "DRF", "Prisma"],
    ...
    },
    {
      title: "Cloud & DevOps",
      icon: Cloud,
      skills: ["AWS", "Docker", "CI/CD", "S3/R2", "Kubernetes (intermediate)"],
      color: "from-orange-500 to-red-500",
    },
    {
      title: "AI Engineering",
      icon: Brain,
      skills: ["LLMs", "RAG", "AI Agents", "LangGraph", "OpenAI API"],
      color: "from-indigo-500 to-blue-500",
    },
    {
      title: "Testing & Tools",
      icon: Wrench,
      skills: ["Jest", "Cypress", "Git/GitHub", "Web Scraping"],
      color: "from-pink-500 to-rose-500",
    },
    {
      title: "Other Technologies",
      icon: Globe,
      skills: ["WebSockets", "Stripe", "WebRTC", "Socket.io"],
